...
class AdminController extends Controller
{
    public function index()
    {
        ...
        $monthlyDatas = DB::select("SELECT M.id As MonthNo, M.name As MonthName,
                        ...
                        IFNULL(D.TotalOrdered,0) As TotalOrderedAmount,
                        IFNULL(D.TotalDelivered,0) As TotalDeliveredAmount,
                        IFNULL(D.TotalCanceled,0) As TotalCanceledAmount FROM month_names M
        ...
        $AmountM = collect($monthlyDatas)->pluck('TotalAmount')->toArray();
        $OrderedAmountM = collect($monthlyDatas)->pluck('TotalOrderedAmount')->toArray();
        $DeliveredAmountM = collect($monthlyDatas)->pluck('TotalDeliveredAmount')->toArray();
        $CanceledAmountM = collect($monthlyDatas)->pluck('TotalCanceledAmount')->toArray();
